...
See the ``chiper-agent-dev`` skill (``references/self-improvement-loop.md``)
...
_SKILL_REVIEW_PROMPT = (
    ...
    "  • Bundled skills (shipped with Chiper, e.g. 'chiper-agent').\n"
    "  • Hub-installed skills (installed via 'chiper skills install').\n"
    "Pinned skills (marked via 'chiper curator pin') CAN be improved — "
...
def build_memory_write_metadata(
    ...
    *,
    ...
    metadata: Dict[str, Any] = {
        ...
        "platform": agent.platform or os.environ.get("CHIPER_SESSION_SOURCE", "cli"),
        "tool_name": "memory",
    }
    if task_id:
