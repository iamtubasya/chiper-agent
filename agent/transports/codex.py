...
class ResponsesApiTransport(ProviderTransport):
    ...
    def build_kwargs(
        ...
        **params,
        ...
        # that would silently route around Chiper's web-provider config and
        ...
        # Chiper's tool-trace / citation plumbing (they arrive baked into the
