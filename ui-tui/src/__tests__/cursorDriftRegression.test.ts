 ...
 *
 * Symptom: in `chiper --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@chiper/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using chiper --tui and as i type multiline my caret at the end will often ' +
