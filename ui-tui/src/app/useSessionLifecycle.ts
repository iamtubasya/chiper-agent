...
import type { ScrollBoxHandle } from '@chiper/ink'
import { evictInkCaches } from '@chiper/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.CHIPER_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
