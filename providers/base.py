...
def _profile_user_agent() -> str:
    """Return a ``chiper-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from chiper_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"chiper-cli/{_ver}"
    except Exception:
        return "chiper-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # chiper-cli UA so the catalog endpoint is reachable.
