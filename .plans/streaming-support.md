# Streaming LLM Response Support for Chiper Agent
...
```
CHIPER_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("CHIPER_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `chiper_cli/config.py` | 1 | +streaming config defaults |
