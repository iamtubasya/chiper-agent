...
import { searchSessions, type SessionInfo, type SessionSearchResult } from '@/chiper'
...
export function ChatSidebar({
  ...
  useEffect(() => {
    ...
    window.addEventListener('chiper:new-session-shortcut', onShortcut)

    return () => {
      window.removeEventListener('chiper:new-session-shortcut', onShortcut)
      clearTimeout(timeout)
    }
  }, [])
