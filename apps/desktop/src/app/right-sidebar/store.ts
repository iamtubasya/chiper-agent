...
const TAKEOVER_KEY = 'chiper.desktop.terminalTakeover'
 ...
 *  (CLI-managed) providers, which Chiper can't clear via the API — the user
 *  sees exactly what runs instead of Chiper silently deleting their creds. */
