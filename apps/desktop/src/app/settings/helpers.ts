import type { ChiperConfigRecord, ToolsetInfo } from '@/types/chiper'
...
export function getNested(obj: ChiperConfigRecord, path: string): unknown {
  let cur: unknown = obj
...
export function setNested(obj: ChiperConfigRecord, path: string, value: unknown): ChiperConfigRecord {
...
function personalityOptions(config: ChiperConfigRecord): string[] {
