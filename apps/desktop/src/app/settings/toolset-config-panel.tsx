...
import type { ActionStatusResponse, ToolEnvVar, ToolProvider, ToolsetConfig } from '@/types/chiper'
 ...
 * log inline — the GUI equivalent of the install step `chiper tools` runs
