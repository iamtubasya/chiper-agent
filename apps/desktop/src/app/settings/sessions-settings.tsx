...
import { deleteSession, listAllProfileSessions, setSessionArchived } from '@/chiper'
...
// / Program Files), which buried any files Chiper wrote there.
function DefaultProjectDirSetting() {
  ...
  useEffect(() => {
    ...
    // / Storybook / non-Electron context `window.chiperDesktop` is
    ...
    const settings = window.chiperDesktop?.settings
