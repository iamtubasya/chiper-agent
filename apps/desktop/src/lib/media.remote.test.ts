...
describe('filePathFromMediaPath', () => {
  it('passes through a plain path', () => {
    expect(filePathFromMediaPath('/home/u/.chiperflux/images/a.png')).toBe('/home/u/.chiperflux/images/a.png')
  })
...
describe('gatewayMediaDataUrl', () => {
  ...
  it('requests the encoded gateway path and returns the data URL', async () => {
    const url = await gatewayMediaDataUrl('/home/u/.chiperflux/images/a b.png')
