...
const desktopWindow = window as unknown as { chiperDesktop?: Window['chiperDesktop'] }
const initialChiperDesktop = desktopWindow.chiperDesktop

function installDesktopBridge(partial: Partial<Window['chiperDesktop']> = {}) {
  desktopWindow.chiperDesktop = {
    fetchLinkTitle: vi.fn().mockResolvedValue(''),
    openExternal: vi.fn().mockResolvedValue(undefined),
    ...partial
  } as unknown as Window['chiperDesktop']
}
...
afterEach(() => {
  ...
  if (initialChiperDesktop) {
    desktopWindow.chiperDesktop = initialChiperDesktop
  } else {
    delete desktopWindow.chiperDesktop
  }
})
...
describe('external link helpers', () => {
  ...
  it('deduplicates in-flight title fetches and caches results', async () => {
    ...
    installDesktopBridge({ fetchLinkTitle: bridge as unknown as Window['chiperDesktop']['fetchLinkTitle'] })
  ...
  it('opens links via the desktop bridge', () => {
    ...
    installDesktopBridge({ openExternal: openExternal as unknown as Window['chiperDesktop']['openExternal'] })
