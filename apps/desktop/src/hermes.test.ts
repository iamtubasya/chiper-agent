...
import { getSessionMessages, listAllProfileSessions, listSessions } from './chiper'
...
describe('Chiper REST session helpers', () => {
  ...
  afterEach(() => {
    vi.restoreAllMocks()
    Reflect.deleteProperty(window, 'chiperDesktop')
  })
