...
Hooks are discovered from ~/.chiperflux/hooks/ directories, each containing:
...
HOOKS_DIR = get_chiper_home() / "hooks"
    ...
    def discover_and_load(self) -> None:
        ...
        for hook_dir in sorted(HOOKS_DIR.iterdir()):
            ...
            try:
                ...
                module_name = f"chiper_hook_{hook_name}"
