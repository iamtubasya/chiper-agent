...
Config: ~/.chiperflux/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.chiperflux/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_chiper_home()`` helper (CHIPER_HOME-aware and
...
RULES_FILE = get_chiper_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_chiper_home() / "feishu_comment_pairing.json"
