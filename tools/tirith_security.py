...
it is automatically downloaded from GitHub releases to $CHIPER_HOME/bin/tirith.
...
def _failure_marker_path() -> str:
    ...
    return os.path.join(_get_chiper_home(), ".tirith-install-failed")
...
def _install_tirith(*, log_failures: bool = True) -> tuple[str | None, str]:
    """Download and install tirith to $CHIPER_HOME/bin/tirith.
...
def _resolve_tirith_path(configured_path: str) -> str:
    ...
    2. $CHIPER_HOME/bin/tirith (previously auto-installed)
    3. Auto-install from GitHub releases → $CHIPER_HOME/bin/tirith
