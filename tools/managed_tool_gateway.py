...
def auth_json_path():
    """Return the Chiper auth store path, respecting CHIPER_HOME overrides."""
    return get_chiper_home() / "auth.json"
...
def peek_nous_access_token() -> Optional[str]:
    ...
    Availability scans (`chiper tools`, banner/status paint, provider
