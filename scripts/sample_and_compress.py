...
DEFAULT_DATASETS = [
    ...
    "NousResearch/chiper-agent-megascience-sft1",
    "NousResearch/Chiper-Agent-Thinking-GLM-4.7-SFT2",
    "NousResearch/Chiper-Agent-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-chiper-agent"
]
