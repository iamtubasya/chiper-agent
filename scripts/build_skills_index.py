#!/usr/bin/env python3
"""Build the Chiper Skills Index — a centralized JSON catalog of all skills.
...
`chiper skills search/install` can use it without hitting the GitHub API.
...
# Ensure CHIPER_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building Chiper Skills Index...", flush=True)
