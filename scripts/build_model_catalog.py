#!/usr/bin/env python3
"""Build the Chiper Model Catalog — a centralized JSON manifest of curated models.
...
Chiper CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a Chiper release.
...
# Ensure CHIPER_HOME is set for imports that touch it at module level.
os.environ.setdefault("CHIPER_HOME", os.path.join(os.path.expanduser("~"), ".chiperflux"))

from chiper_cli.models import OPENROUTER_MODELS, _PROVIDER_MODELS  # noqa: E402
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "chiper-agent repo",
            "docs": "https://chiper-agent.nousresearch.com/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
