...
export const fr: Translations = {
  ...
  status: {
    ...
    stopped: "Arrêté",
    updateChiper: "Mettre à jour Chiper",
    updatingChiper: "Mise à jour de Chiper…",
  ...
  pluginsPage: {
    ...
    headline:
      "Découvrez, installez, activez et mettez à jour les plugins Chiper (parité avec `chiper plugins`).",
    ...
    removeConfirm: "Retirer ce plugin de ~/.chiperflux/plugins/ ?",
    removeHint: "Seuls les plugins installés par l'utilisateur sous ~/.chiperflux/plugins peuvent être supprimés.",
  ...
  skills: {
    ...
    filters: "Filtres",
    noSkills: "Aucune compétence trouvée. Les compétences sont chargées depuis ~/.chiperflux/skills/",
  ...
  config: {
    configPath: "~/.chiperflux/config.yaml",
    filters: "Filtres",
    sections: "Sections",
  ...
  achievements: {
    hero: {
      ...
      title: "Chiper Achievements",
      subtitle:
        "Badges Chiper à collectionner, gagnés à partir de l'historique réel des sessions. Les succès connus non terminés sont affichés comme Découverts ; les succès secrets restent cachés jusqu'à l'apparition du premier comportement correspondant.",
      scan_subtitle:
        "Analyse de l'historique des sessions Chiper en cours. Le premier scan peut prendre 5 à 10 secondes sur les historiques volumineux.",
    },
    actions: {
    ...
    stats: {
      ...
      latest: "Dernier",
      latest_hint_empty: "utilisez Chiper davantage",
    ...
    guide: {
      ...
      secret_body:
        "Les secrets cachent leur déclencheur exact. Dès qu'Chiper détecte un signal lié, la carte passe à Découvert et affiche son exigence.",
      scan_status_header: "État du scan",
      scan_status_body:
        "Chiper analyse l'historique local une seule fois, puis les cartes apparaîtront automatiquement. Rien n'est bloqué si cela prend quelques secondes.",
    ...
    share: {
      ...
      tweet_text: "Just unlocked {tier_part}\"{name}\" in Chiper Agent ☤",
    },
  },
  kanban: {
