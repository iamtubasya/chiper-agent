 ...
 *
 * Plugins call window.__CHIPER_PLUGINS__.register(name, Component)
 ...
 * Exposed at runtime as ``window.__CHIPER_PLUGIN_SDK__.sdkVersion`` so a
...
export function exposePluginSDK() {
  window.__CHIPER_PLUGINS__ = {
    register: registerPlugin,
    registerSlot,
  };

  window.__CHIPER_PLUGIN_SDK__ = {
    ...
    // window.__CHIPER_SESSION_TOKEN__ directly.
    authedFetch,
