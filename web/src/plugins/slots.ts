 ...
 * `window.__CHIPER_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the Chiper brand in the top bar
 ...
 *  `window.__CHIPER_PLUGINS__.registerSlot(...)`.
 *
