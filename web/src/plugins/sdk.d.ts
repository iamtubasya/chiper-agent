/**
 * Chiper Dashboard Plugin SDK — typed contract (SPIKE)
 * ====================================================
 *
 * This is the public type surface for ``window.__CHIPER_PLUGIN_SDK__`` and
 * ``window.__CHIPER_PLUGINS__``, the globals the dashboard host exposes to
 ...
 * window.__CHIPER_PLUGIN_SDK__`` because:
 ...
 *
 * Versioning: bump ``ChiperPluginSDK["sdkVersion"]`` (and the
 ...
 *   - Ship as a published ``@chiper/dashboard-plugin-sdk`` types package, or
 ...
 * of calling ``fetch`` with a hand-read ``window.__CHIPER_SESSION_TOKEN__``.
 */
...
// ---------------------------------------------------------------------------
// Registry surface (window.__CHIPER_PLUGINS__)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// SDK surface (window.__CHIPER_PLUGIN_SDK__)
// ---------------------------------------------------------------------------

export interface ChiperPluginSDK {
...
declare global {
  interface Window {
    __CHIPER_PLUGIN_SDK__?: ChiperPluginSDK;
    __CHIPER_PLUGINS__?: PluginRegistry;
  }
}
