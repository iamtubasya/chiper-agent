 ...
 * `_BUILTIN_DASHBOARD_THEMES` list in `chiper_cli/web_server.py`.
 */
...
export const defaultTheme: DashboardTheme = {
  name: "default",
  label: "Chiper Teal",
  description: "Classic dark teal — the canonical Chiper look",
  palette: {
...
/**
 * Nous Blue — the inverted "light mode" Chiper look, ported from the
 ...
 * nousnet-web's <body> is white; chiper-agent's App root is `bg-black`,
...
export const defaultLargeTheme: DashboardTheme = {
  name: "default-large",
  label: "Chiper Teal (Large)",
  description: "Chiper Teal with bigger fonts and roomier spacing",
