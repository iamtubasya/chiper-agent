...
const STORAGE_KEY = "chiper-dashboard-theme";
...
const FONT_STORAGE_KEY = "chiper-dashboard-font";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `chiper_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "chiper-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-chiper-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-chiper-theme-font", "true");
