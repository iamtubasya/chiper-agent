"""``chiper tools`` subcommand parser.
...
def build_tools_parser(subparsers, *, cmd_tools: Callable) -> None:
    ...
    tools_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "Run 'chiper tools' with no subcommand for the interactive configuration UI."
        ),
    )
    ...
    # chiper tools list [--platform cli]
    ...
    # chiper tools disable <name...> [--platform cli]
    ...
    # chiper tools enable <name...> [--platform cli]
    ...
    tools_postsetup_p = tools_sub.add_parser(
        ...
        description=(
            ...
            "same step `chiper tools` runs after you pick a provider that\n"
