...
def build_gateway_parser(
    ...
    gateway_run.add_argument(
        ...
        help=(
            ...
            "if CHIPER_DASHBOARD is set). Pass --no-supervise to opt out and "
    ...
    gateway_enroll = gateway_subparsers.add_parser(
        ...
        description=(
            ...
            "GATEWAY_RELAY_SECRET / GATEWAY_RELAY_DELIVERY_KEY into ~/.chiperflux/.env. "
            "Requires being logged in (chiper setup). Not available in managed installs."
        ),
    )
