...
def build_dashboard_parser(
    ...
    dashboard_parser = subparsers.add_parser(
        ...
        description="Launch the Chiper Agent web dashboard for managing config, API keys, and sessions",
    )
    ...
    # Backward-compat shim: older Chiper desktop app shells (<= 0.15.x) spawn the
    ...
    # showed "Chiper couldn't start" with no actionable cause. Accept and silently
    ...
    dashboard_register_parser = dashboard_subparsers.add_parser(
        ...
        description=(
            ...
            "CHIPER_DASHBOARD_OAUTH_CLIENT_ID into ~/.chiperflux/.env, and prints "
            "how to engage the login gate. Requires being logged in (chiper setup)."
        ),
    )
    ...
    dashboard_register_parser.add_argument(
        ...
        help=(
            ...
            "https://chiper.example.com/auth/callback. Omit for localhost-only use."
        ),
    )
    dashboard_register_parser.add_argument(
        "--portal-url",
        ...
        help=(
            ...
            "portal. Also settable via CHIPER_DASHBOARD_PORTAL_URL. Mainly for "
