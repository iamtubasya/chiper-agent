...
from chiper_cli.subcommands._shared import add_accept_hooks_flag
...
def build_acp_parser(subparsers, *, cmd_acp: Callable) -> None:
    ...
    acp_parser = subparsers.add_parser(
        "acp",
        help="Run Chiper Agent as an ACP (Agent Client Protocol) server",
        description="Start Chiper Agent in ACP mode for editor integration (VS Code, Zed, JetBrains)",
    )
    ...
    acp_parser.add_argument(
        ...
        action="store_true",
        dest="acp_version",
        help="Print Chiper ACP version and exit",
    )
    acp_parser.add_argument(
        "--check",
        action="store_true",
