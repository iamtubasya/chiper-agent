...
- chiper chat          - Interactive chat (same as ./chiper)
...
def _ensure_utf8():
    ...
    can even start — e.g. `chiper setup` on a fresh Pi.
    ...
    chiper_cli/stdio.py::configure_windows_stdio() runs later from the entry
