...
Used by ``chiper profile describe <name> --auto`` and the dashboard's
...
Design notes
------------
- Mirrors the shape of ``chiper_cli/kanban_specify.py``: lazy aux
...
_SYSTEM_PROMPT = """You are a profile-describer for the Chiper Agent kanban board.
...
Rules:
  ...
  - Never write "Chiper Agent profile" or other meta-narration.
    ...
    *,
    ...
    try:
        if canon == "default":
            ...
            profile_dir = Path(get_chiper_home())
        else:
