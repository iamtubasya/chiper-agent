"""
Skills configuration for Chiper Agent.
`chiper skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.chiperflux/config.yaml under:
...
from chiper_cli.config import cfg_get, load_config, save_config
from chiper_cli.colors import Colors, color
from chiper_cli.platforms import PLATFORMS as _PLATFORMS
