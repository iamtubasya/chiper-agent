...
Invoked by ``chiper kanban decompose [task_id | --all]`` and the
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the Chiper Agent board.
...
def _profile_author() -> str:
    """Mirror of ``chiper_cli.kanban._profile_author``."""
    return (
