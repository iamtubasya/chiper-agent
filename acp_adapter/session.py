...
def _translate_acp_cwd(cwd: str) -> str:
    ...
    """
    from chiper_constants import is_wsl
...
class SessionManager:
    ...
    def _get_db(self):
        ...
        Note: we resolve ``CHIPER_HOME`` dynamically rather than relying on
        ...
        later (e.g. by the test fixture ``_isolate_chiper_home``).
        """
        ...
        try:
            ...
            self._db_instance = SessionDB(db_path=chiper_home / "state.db")
            return self._db_instance
        except Exception:
