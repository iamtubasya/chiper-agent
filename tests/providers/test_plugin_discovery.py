...
Verifies that:
 ...
 2. User plugins at $CHIPER_HOME/plugins/model-providers/<name>/ override bundled
...
def test_user_plugin_overrides_bundled(tmp_path, monkeypatch):
    ...
    user_gmi = chiper_home / "plugins" / "model-providers" / "gmi"
...
def test_general_plugin_manager_skips_model_provider_kind(tmp_path, monkeypatch):
    ...
    user_plugin = chiper_home / "plugins" / "test-model-provider"
