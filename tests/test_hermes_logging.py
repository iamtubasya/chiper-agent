...
class TestSetupLogging:
    ...
    def test_creates_log_directory(self, chiper_home):
        log_dir = hermes_logging.setup_logging(chiper_home=chiper_home)
        assert log_dir == chiper_home / "logs"
        assert log_dir.is_dir()

    def test_creates_agent_log_handler(self, chiper_home):
        hermes_logging.setup_logging(chiper_home=chiper_home)
        root = logging.getLogger()
    ...
    def test_idempotent_no_duplicate_handlers(self, chiper_home):
        hermes_logging.setup_logging(chiper_home=chiper_home)
        hermes_logging.setup_logging(chiper_home=chiper_home)  # second call — should be no-op
    ...
    def test_force_reinitializes(self, chiper_home):
        ...
        hermes_logging.setup_logging(chiper_home=chiper_home, force=True)
    ...
    def test_custom_log_level(self, chiper_home):
        hermes_logging.setup_logging(chiper_home=chiper_home, log_level="DEBUG")
    ...
    def test_explicit_params_override_config(self, chiper_home):
        ...
        hermes_logging.setup_logging(chiper_home=chiper_home, log_level="WARNING")
...
class TestGatewayMode:
    ...
    def test_gateway_log_created(self, chiper_home):
        hermes_logging.setup_logging(chiper_home=chiper_home, mode="gateway")
        root = logging.getLogger()
    ...
    def test_gateway_log_not_created_in_cli_mode(self, chiper_home):
        hermes_logging.setup_logging(chiper_home=chiper_home, mode="cli")
        root = logging.getLogger()
...
class TestGuiMode:
    ...
    def test_gui_log_created(self, chiper_home):
        hermes_logging.setup_logging(chiper_home=chiper_home, mode="gui")
        root = logging.getLogger()
