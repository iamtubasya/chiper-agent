...
def store(tmp_path, monkeypatch):
    ...
    ~/.chiperflux/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at hermes_state import time, before pytest's CHIPER_HOME monkeypatch
    fires — the autouse fixture's CHIPER_HOME override doesn't help here.)
    """
    import chiper_state
