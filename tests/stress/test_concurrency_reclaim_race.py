...
def worker_loop(worker_id: int, chiper_home: str, result_file: str) -> None:
...
def reclaimer_loop(chiper_home: str, result_file: str) -> None:
    os.environ["CHIPER_HOME"] = chiper_home
    os.environ["HOME"] = chiper_home
    sys.path.insert(0, WT)
    from chiper_cli import kanban_db as kb
...
def main():
    home = tempfile.mkdtemp(prefix="chiper_reclaim_race_")
