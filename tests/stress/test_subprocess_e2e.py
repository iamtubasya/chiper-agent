...
This validates the IPC + lifecycle story that mocks can't:
  ...
  - the child process resolves chiper_cli.kanban_db on its own
  ...
  - worker logs are captured to CHIPER_HOME/kanban/logs/<task>.log
    ...
    def _spawn(task, workspace):
        ...
        env = {
            **os.environ,
            ...
            "HOME": home,
            "PYTHONPATH": WT,
            "CHIPER_KANBAN_TASK": task.id,
            "CHIPER_KANBAN_WORKSPACE": workspace,
