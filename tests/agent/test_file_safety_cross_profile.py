...
accidentally edited skills under both ~/.chiperflux/profiles/hermes-security/skills/
...
def fake_hermes(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr(hermes_constants, "get_default_chiper_root", lambda: root)
