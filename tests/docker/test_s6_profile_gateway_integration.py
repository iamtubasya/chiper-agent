...
The unit tests in tests/chiper_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned chiper-writable by the
...
_REGISTER_SCRIPT = """
import sys
sys.path.insert(0, "/opt/chiper")
from chiper_cli.service_manager import S6ServiceManager
