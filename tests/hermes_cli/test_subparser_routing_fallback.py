...
The main() function in chiper_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `chiper -c model`
...
def _build_parser():
    """Build a minimal replica of the chiper top-level parser."""
