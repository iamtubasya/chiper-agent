...
class TestPublicUrlOverride:
    ...
    def test_public_url_with_path_prefix_baked_in(
        ...
        patch_config(None)
        monkeypatch.setenv(
            "CHIPER_DASHBOARD_PUBLIC_URL", "https://example.com/hermes",
        )
        redirect_uri = self._redirect_uri(gated_app_direct)
    ...
    def test_scheme_less_public_url_env_warns_operator(
        ...
        patch_config(None)
        monkeypatch.setenv("CHIPER_DASHBOARD_PUBLIC_URL", "hermes.domain.com")
    ...
    def test_valid_public_url_emits_no_warning(
        ...
        patch_config(None)
        monkeypatch.setenv(
            "CHIPER_DASHBOARD_PUBLIC_URL", "https://hermes.domain.com"
        )
