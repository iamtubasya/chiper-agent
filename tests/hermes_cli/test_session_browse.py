"""Tests for the interactive session browser (`chiper sessions browse`).
...
from chiper_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """chiper sessions browse should be parseable."""
