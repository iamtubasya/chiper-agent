"""Tests for the specifier module + `chiper kanban specify` CLI surface.
...
from chiper_cli import kanban as kanban_cli
...
def _run_cli(*argv: str) -> int:
    """Invoke the `chiper kanban …` argparse surface directly."""
