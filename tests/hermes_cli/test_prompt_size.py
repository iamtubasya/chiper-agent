...
from chiper_cli.prompt_size import (
    _SKILLS_BLOCK_RE,
...
def _seed_memory(chiper_home, memory_text="", user_text=""):
    mem_dir = chiper_home / "memories"
...
def _seed_skill(chiper_home, name, description):
    skill_dir = chiper_home / "skills" / "demo" / name
