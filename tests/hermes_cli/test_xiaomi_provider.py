...
class TestXiaomiNormalization:
    ...
    def test_vendor_prefix_mapping(self):
        from chiper_cli.model_normalize import _VENDOR_PREFIXES
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in CHIPER_OVERLAYS
        overlay = CHIPER_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify chiper doctor recognizes Xiaomi env vars."""
