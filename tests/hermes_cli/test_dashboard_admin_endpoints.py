...
class TestMemoryEndpoints:
    ...
    def _setup(self, _isolate_chiper_home):
        ...
        (get_chiper_home() / "memories").mkdir(parents=True, exist_ok=True)
...
class TestSkillsHubPreviewEndpoint:
    ...
    def test_preview_returns_skill_md_text(self, monkeypatch):
        ...
        monkeypatch.setattr(
            "chiper_cli.skills_hub._resolve_source_meta_and_bundle",
...
class TestDebugShareEndpoint:
    ...
    def test_returns_structured_urls(self, monkeypatch):
        import chiper_cli.debug as dbg
        ...
        monkeypatch.setattr("chiper_cli.dump.run_dump", lambda a: None)
