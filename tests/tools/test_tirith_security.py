...
class TestInstallArchiveMemberValidation:
    ...
    def test_install_extracts_regular_tirith_member(self, mock_target, mock_which,
        ...
        assert reason == ""
        assert path == str(chiper_home / "bin" / "tirith")
    ...
    def test_install_rejects_non_regular_tirith_member(self, mock_target, mock_which,
        ...
        assert not os.path.lexists(chiper_home / "bin" / "tirith")
...
class TestChiperHomeIsolation:
    ...
    def test_get_chiper_home_fallback(self):
        ...
        from tools.tirith_security import _get_chiper_home
        with patch.dict(os.environ, {}, clear=True):
            # Remove CHIPER_HOME entirely. With HOME also absent, expanduser
