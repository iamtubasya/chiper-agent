...
Opt-in — not part of default CI:
    CHIPER_LIVE_TESTS=1 pytest tests/run_agent/test_sequential_chats_live.py -v

Requires ``OPENROUTER_API_KEY`` to be set (or sourced via ~/.chiperflux/.env).
"""
...
LIVE = os.environ.get("CHIPER_LIVE_TESTS") == "1"
OR_KEY = os.environ.get("OPENROUTER_API_KEY", "")

pytestmark = [
    pytest.mark.skipif(not LIVE, reason="live-only — set CHIPER_LIVE_TESTS=1"),
