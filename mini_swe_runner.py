#!/usr/bin/env python3
"""
SWE Runner with Chiper Trajectory Format

A runner that uses Chiper-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Chiper-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Chiper-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Chiper format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Chiper-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Chiper-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Chiper Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Chiper-Agent's built-in execution environments
    and outputs trajectories in Chiper-Agent format.
    """
    ...
    def _convert_to_chiper_format(
        ...
        """
        Convert internal message format to Chiper trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Chiper trajectory format
        trajectory = self._convert_to_chiper_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Chiper trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Chiper Trajectory Format")
    print("=" * 60)
