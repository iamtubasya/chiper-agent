...
(`hermes mcp install <name>`): `skill_view(name="chiper-agent", file_path="references/native-mcp.md")`.
...
|----------------|----------|
| Config options | `hermes config edit` or [Configuration docs](https://chiper-agent.nousresearch.com/docs/user-guide/configuration) |
| Available tools | `hermes tools list` or [Tools reference](https://chiper-agent.nousresearch.com/docs/reference/tools-reference) |
...
| Skills catalog | `hermes skills browse` or [Skills catalog](https://chiper-agent.nousresearch.com/docs/reference/skills-catalog) |
| Provider setup | `hermes model` or [Providers guide](https://chiper-agent.nousresearch.com/docs/integrations/providers) |
| Platform setup | `hermes gateway setup` or [Messaging docs](https://chiper-agent.nousresearch.com/docs/user-guide/messaging/) |
| MCP servers | `hermes mcp list` or [MCP guide](https://chiper-agent.nousresearch.com/docs/user-guide/features/mcp) |
| Profiles | `hermes profile list` or [Profiles docs](https://chiper-agent.nousresearch.com/docs/user-guide/profiles) |
| Cron jobs | `hermes cron list` or [Cron docs](https://chiper-agent.nousresearch.com/docs/user-guide/features/cron) |
| Memory | `hermes memory status` or [Memory docs](https://chiper-agent.nousresearch.com/docs/user-guide/features/memory) |
| Env variables | `hermes config env-path` or [Env vars reference](https://chiper-agent.nousresearch.com/docs/reference/environment-variables) |
| CLI commands | `hermes --help` or [CLI reference](https://chiper-agent.nousresearch.com/docs/reference/cli-commands) |
...
- Use `get_chiper_home()` from `hermes_constants` for all paths (profile-safe)
