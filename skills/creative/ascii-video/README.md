...
Built for [Hermes Agent](https://github.com/NousResearch/chiper-agent). Usable in any coding agent. Canonical source lives here; synced to [`NousResearch/chiper-agent/skills/creative/ascii-video`](https://github.com/NousResearch/chiper-agent/tree/main/skills/creative/ascii-video) via PR.
