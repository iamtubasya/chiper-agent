...
```bash
python3 -m pyfiglet "CHIPER" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=CHIPER&font=Slant" | boxes -d stone
```
