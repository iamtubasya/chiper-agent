...
_CHIPER_CORE_TOOLS = [
    ...
    "terminal", "process",
    # Read the desktop GUI's embedded terminal pane (gated on CHIPER_DESKTOP
    ...
    # spawned as a kanban worker (CHIPER_KANBAN_TASK env set) or the current
...
TOOLSETS = {
    ...
    "kanban": {
        "description": (
            ...
            "is spawned by the kanban dispatcher (CHIPER_KANBAN_TASK env "
    ...
    "coding": {
        ...
        # non-configurable-toolset recovery loop in chiper_cli/tools_config.py).
        "posture": True,
    },
