...
``_check_spotify_available()`` — when the user has not run ``chiper auth
spotify``, the tools remain registered (so they appear in ``chiper
...
The Spotify auth flow (``chiper auth spotify``), CLI plumbing, and docs
