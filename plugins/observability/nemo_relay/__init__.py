...
def _load_settings() -> _Settings:
    ...
    return _Settings(
        ...
        atof_filename=_env("CHIPER_NEMO_RELAY_ATOF_FILENAME") or "hermes-atof.jsonl",
        ...
        atif_filename_template=_env("CHIPER_NEMO_RELAY_ATIF_FILENAME_TEMPLATE") or "hermes-atif-{session_id}.json",
