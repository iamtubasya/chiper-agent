"""`chiper meet node ...` subcommand tree.

Wired into the existing ``chiper meet`` parser by the plugin's top-level
...
def register_cli(subparser: argparse.ArgumentParser) -> None:
    ...
    *subparser* is the ``chiper meet node`` argparse object — typically
