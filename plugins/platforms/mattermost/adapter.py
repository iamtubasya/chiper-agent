...
def interactive_setup() -> None:
    ...
    ``chiper_cli/setup.py::_setup_mattermost`` function this migration
    removes.
    """
    ...
    print()
    print_info("📬 Home Channel: where Chiper delivers cron job results and notifications.")
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # chiper_cli/setup.py::_setup_mattermost function.
