...
ACHIEVEMENTS: List[Dict[str, Any]] = [
    ...
    # Hermes Native
    {"id": "skillsmith", "name": "Skillsmith", "description": "Work with Chiper skills enough to leave fingerprints.", "category": "Hermes Native", "kind": "lifetime", "icon": "hammer_scroll", "threshold_metric": "skill_events", "tiers": tiers([5000, 15000, 40000, 100000, 250000])},
...
def state_path() -> Path:
    return get_chiper_home() / "plugins" / "hermes-achievements" / "state.json"


def snapshot_path() -> Path:
    return get_chiper_home() / "plugins" / "hermes-achievements" / "scan_snapshot.json"


def checkpoint_path() -> Path:
    return get_chiper_home() / "plugins" / "hermes-achievements" / "scan_checkpoint.json"
