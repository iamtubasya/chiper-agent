...
- Snapshot persisted at `~/.chiperflux/plugins/hermes-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.chiperflux/plugins/hermes-achievements/scan_checkpoint.json`.
