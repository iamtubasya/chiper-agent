# Chiper Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.chiperflux/plugins/chiper-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.chiperflux/plugins/chiper-achievements/scan_checkpoint.json`.
