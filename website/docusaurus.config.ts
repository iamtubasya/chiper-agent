...
const config: Config = {
  ...
  url: 'https://chiper-agent.nousresearch.com',
  baseUrl: '/docs/',

  organizationName: 'NousResearch',
  projectName: 'chiper-agent',
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: 'https://github.com/NousResearch/chiper-agent/edit/main/website/',
        },
        blog: false,
        theme: {
  ...
  themeConfig: {
    image: 'img/chiper-agent-banner.png',
    colorMode: {
      defaultMode: 'dark',
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://chiper-agent.nousresearch.com/',
          label: 'Download',
          position: 'left',
        },
        {
        ...
        {
          href: 'https://github.com/NousResearch/chiper-agent',
          label: 'GitHub',
          position: 'right',
        },
        {
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'GitHub Issues', href: 'https://github.com/NousResearch/chiper-agent/issues' },
        ...
        },
        {
          title: 'More',
          items: [
            { label: 'Desktop Download', href: 'https://chiper-agent.nousresearch.com/' },
            { label: 'GitHub', href: 'https://github.com/NousResearch/chiper-agent' },
