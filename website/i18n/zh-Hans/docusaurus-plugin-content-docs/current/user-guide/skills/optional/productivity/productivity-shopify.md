...
| | |
|---|---|
| 来源 | 可选 — 通过 `chiper skills install official/productivity/shopify` 安装 |
...
}' '{"input":{"title":"Test Hoodie","status":"DRAFT","vendor":"Chiper","productType":"Apparel","tags":["test"]}}'
```
