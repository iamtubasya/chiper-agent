#!/usr/bin/env python3
"""Generate llms.txt and llms-full.txt for the Chiper docs site.
...
Both publish at:
  https://chiper-agent.nousresearch.com/docs/llms.txt
  https://chiper-agent.nousresearch.com/docs/llms-full.txt
...
SITE_BASE = "https://chiper-agent.nousresearch.com/docs"
...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Guides & Tutorials", [
        ...
        ("guides/python-library", "Use Chiper as a Python Library", None),
        ("guides/use-mcp-with-chiper", "Use MCP with Chiper", None),
        ("guides/use-voice-mode-with-chiper", "Use Voice Mode with Chiper", None),
        ("guides/use-soul-with-chiper", "Use SOUL.md with Chiper", None),
        ("guides/build-a-chiper-plugin", "Build a Chiper Plugin", None),
    ...
    ("Reference", [
        ...
        ("reference/skills-catalog", "Bundled Skills Catalog", "Table of all ~90 skills bundled with Chiper"),
...
def emit_llms_index() -> str:
    ...
    lines.append(
        ...
        "chiper-agent/main/scripts/install.sh | bash`  "
        "(Linux, macOS, WSL2, Termux)"
    )
    lines.append("")
    lines.append("Repo: https://github.com/NousResearch/chiper-agent")
    lines.append("")
...
def emit_llms_full() -> str:
    ...
    seen: set[Path] = set()
    chunks: list[str] = [
        "# Chiper Agent — Full Documentation\n",
        (
            "This file is the entire Chiper Agent documentation concatenated for LLM "
            "context ingestion. Section order reflects docs-site navigation: Getting "
            "Started, Using Chiper, Features, Messaging, Integrations, Guides, "
            "Developer Guide, Reference, then everything else.\n"
        ),
        "Canonical site: https://chiper-agent.nousresearch.com/docs\n",
        "Short index: https://chiper-agent.nousresearch.com/docs/llms.txt\n",
        "\n---\n\n",
    ]
