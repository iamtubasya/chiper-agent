...
Set your Tenor API key in your environment (add to `~/.chiperflux/.env`):
...
- GIF URLs can be used directly in markdown: `![alt](https://github.com/NousResearch/chiper-agent/blob/main/skills/media/gif-search/url)`
