---
title: "Chiper Agent Skill Authoring — Author in-repo SKILL"
sidebar_label: "Chiper Agent Skill Authoring"
description: "Author in-repo SKILL"
---

{/* This page is auto-generated from the skill's SKILL.md by website/scripts/generate-skill-docs.py. Edit the source SKILL.md, not this page. */}

# Chiper Agent Skill Authoring
...
| Path | `skills/software-development/chiper-agent-skill-authoring` |
| Version | `1.0.0` |
| Author | Chiper Agent |
| License | MIT |
...
1. **User-local:** `~/.chiperflux/skills/<maybe-category>/<name>/SKILL.md` — personal, not shared. Created via `skill_manage(action='create')`.
2. **In-repo (this skill is about this case):** `/home/bb/chiper-agent/skills/<category>/<name>/SKILL.md` — committed, shipped with the package. Use `write_file` + `git add`. `skill_manage(action='create')` does NOT target this tree.

## When to Use

- User asks you to add a skill "in this branch / repo / commit"
- You're committing a reusable workflow that should ship with chiper-agent
- You're editing an existing skill under `/home/bb/chiper-agent/skills/` (use `patch` for small edits, `write_file` for rewrites; `skill_manage` still works for patch on in-repo skills, but not for `create`)
...
1. **Using `skill_manage(action='create')` for an in-repo skill.** It writes to `~/.chiperflux/skills/`, not the repo tree. Use `write_file` for in-repo creation.
