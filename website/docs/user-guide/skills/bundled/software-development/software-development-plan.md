...
Plan mode: write an actionable markdown plan to .chiper/plans/, no execution. Bite-sized tasks, exact paths, complete code.
...
- Your deliverable is a markdown plan saved inside the active workspace under `.chiper/plans/`.
...
- `.chiper/plans/YYYY-MM-DD_HHMMSS-<slug>.md`
...
If not, create a sensible timestamped filename yourself under `.chiper/plans/`.
