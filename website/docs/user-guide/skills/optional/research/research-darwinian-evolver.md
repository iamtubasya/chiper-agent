...
| | |
|---|---|
| Source | Optional — install with `chiper skills install official/research/darwinian-evolver` |
| Path | `optional-skills/research/darwinian-evolver` |
| Version | `0.1.0` |
| Author | Bihruze (Asahi0x), Chiper Agent |
| License | MIT |
...
import upstream classes into Chiper itself.
...
Open `~/.chiperflux/cache/darwinian-evolver/darwinian_evolver/darwinian_evolver/lineage_visualizer.html`
...
7. **AGPL.** Never `from darwinian_evolver import ...` inside Chiper core.
   Custom driver scripts under `~/.chiperflux/skills/...` are user-side and fine.
