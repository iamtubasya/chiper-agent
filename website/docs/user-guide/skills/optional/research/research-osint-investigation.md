...
| | |
|---|---|
| Source | Optional — install with `chiper skills install official/research/osint-investigation` |
| Path | `optional-skills/research/osint-investigation` |
| Version | `0.1.0` |
| Author | Chiper Agent (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
...
# $CHIPER_OSINT_CACHE/icij/ (default: ~/.cache/chiper-osint/icij/).
...
# Set CHIPER_OSINT_UA=your-app/1.0 (your@email) to identify yourself
