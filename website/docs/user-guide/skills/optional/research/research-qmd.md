...
| | |
|---|---|
| Source | Optional — install with `chiper skills install official/research/qmd` |
...
Chiper Agent via the native MCP client. This is the preferred
...
Then configure Chiper Agent to connect via HTTP:
