...
| | |
|---|---|
| Source | Optional — install with `chiper skills install official/creative/pixel-art` |
...
```python
import sys
sys.path.insert(0, "/home/teknium/.chiperflux/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.chiperflux/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Chiper installs package this)
