...
- User wants **Chiper itself to drive a browser** → use Chiper' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
