...
| | |
|---|---|
| Source | Optional — install with `chiper skills install official/finance/stocks` |
| Path | `optional-skills/finance/stocks` |
| Version | `0.1.0` |
| Author | Mibay (Mibayy), Chiper Agent |
| License | MIT |
...
```
SCRIPT=~/.chiperflux/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.chiperflux/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
