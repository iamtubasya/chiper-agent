...
| | |
|---|---|
| Source | Optional — install with `chiper skills install official/productivity/siyuan` |
...
```yaml
# In ~/.chiperflux/config.yaml under mcp_servers:
mcp_servers:
  siyuan:
    command: npx
