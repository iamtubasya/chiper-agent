...
| | |
|---|---|
| Source | Optional — install with `chiper skills install official/productivity/canvas` |
...
4. Name the token (e.g., "Chiper Agent"), set an optional expiry, and click **Generate Token**
5. Copy the token and add to `~/.chiperflux/.env`:
