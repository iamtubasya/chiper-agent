...
| | |
|---|---|
| Source | Optional — install with `chiper skills install official/health/neuroskill-bci` |
...
Connect Chiper to a running [NeuroSkill](https://neuroskill.com/) instance to read
