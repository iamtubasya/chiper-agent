...
The Baileys bridge saves its session under `~/.chiperflux/platforms/whatsapp/session`. This means:
...
- The `~/.chiperflux/platforms/whatsapp/session` directory contains full session credentials — protect it like a password
- Set file permissions: `chmod 700 ~/.chiperflux/platforms/whatsapp/session`
