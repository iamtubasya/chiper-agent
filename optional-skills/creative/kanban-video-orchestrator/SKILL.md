...
8. **Verify API keys BEFORE firing.** External APIs (TTS, image-gen,
   image-to-video) need keys in `${CHIPER_HOME:-~/.chiperflux}/.env` or the user's secret store.
