...
12. **execute_code sandbox has no env vars** — When Chiper runs auto_jailbreak via execute_code, the sandbox doesn't inherit the Chiper `.env`. Load dotenv explicitly: `import os; from dotenv import load_dotenv; load_dotenv(os.path.join(os.environ.get("CHIPER_HOME", os.path.expanduser("~/.chiperflux")), ".env"))`
